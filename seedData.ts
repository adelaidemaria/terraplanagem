...
export const seedDatabase = () => {
  ...
  const sales: Sale[] = [
    { id: crypto.randomUUID(), customerId: customers[0].id, customerName: customers[0].name, accountPlanId: accountPlan[0].id, items: [{ id: crypto.randomUUID(), description: 'Terraplanagem Loteamento', value: 15000 }], totalValue: 15000, date: new Date().toLocaleDateString('en-CA'), nfNumber: '1001', saleType: 'Serviço', paymentMethod: 'Boleto', paymentCondition: 'A Prazo', installments: 3, dueDate: new Date().toLocaleDateString('en-CA'), status: 'Pendente', createdAt: Date.now() },
    { id: crypto.randomUUID(), customerId: customers[1].id, customerName: customers[1].name, accountPlanId: accountPlan[1].id, items: [{ id: crypto.randomUUID(), description: 'Locação Bobcat 2 dias', value: 1200 }], totalValue: 1200, date: new Date().toLocaleDateString('en-CA'), nfNumber: '1002', saleType: 'Locação', paymentMethod: 'PIX', paymentCondition: 'A Vista', installments: 1, status: 'Pago', createdAt: Date.now() },
    { id: crypto.randomUUID(), customerId: customers[2].id, customerName: customers[2].name, accountPlanId: accountPlan[2].id, items: [{ id: crypto.randomUUID(), description: 'Limpeza de Terreno', value: 3500 }], totalValue: 3500, date: new Date().toLocaleDateString('en-CA'), nfNumber: '1003', saleType: 'Serviço', paymentMethod: 'Cartão', paymentCondition: 'A Vista', installments: 1, status: 'Pendente', createdAt: Date.now() },
    { id: crypto.randomUUID(), customerId: customers[3].id, customerName: customers[3].name, accountPlanId: accountPlan[0].id, items: [{ id: crypto.randomUUID(), description: 'Nivelamento de Rua', value: 25000 }], totalValue: 25000, date: new Date().toLocaleDateString('en-CA'), nfNumber: '1004', saleType: 'Serviço', paymentMethod: 'Transferência', paymentCondition: 'A Prazo', installments: 1, dueDate: new Date().toLocaleDateString('en-CA'), status: 'Pendente', createdAt: Date.now() },
    { id: crypto.randomUUID(), customerId: customers[4].id, customerName: customers[4].name, accountPlanId: accountPlan[1].id, items: [{ id: crypto.randomUUID(), description: 'Locação Escavadeira 1 semana', value: 8000 }], totalValue: 8000, date: new Date().toLocaleDateString('en-CA'), nfNumber: '1005', saleType: 'Locação', paymentMethod: 'Boleto', paymentCondition: 'A Prazo', installments: 2, dueDate: new Date().toLocaleDateString('en-CA'), status: 'Parcial', createdAt: Date.now() }
  ];

  const payments: Payment[] = [
    { id: crypto.randomUUID(), saleId: sales[1].id, bankAccountId: bankAccounts[0].id, amount: 1200, date: new Date().toLocaleDateString('en-CA'), method: 'PIX', createdAt: Date.now() },
    { id: crypto.randomUUID(), saleId: sales[4].id, bankAccountId: bankAccounts[1].id, amount: 4000, date: new Date().toLocaleDateString('en-CA'), method: 'Boleto', createdAt: Date.now() }
  ];

  const expenses: Expense[] = [
    { id: crypto.randomUUID(), vendorId: vendors[0].id, vendorName: vendors[0].name, accountPlanId: accountPlan[3].id, items: [{ id: crypto.randomUUID(), description: 'Diesel S10 500L', value: 3000 }], totalValue: 3000, date: new Date().toLocaleDateString('en-CA'), docNumber: '5544', paymentMethod: 'Boleto', paymentCondition: 'A Prazo', dueDate: new Date().toLocaleDateString('en-CA'), status: 'Pendente', createdAt: Date.now() },
    { id: crypto.randomUUID(), vendorId: vendors[1].id, vendorName: vendors[1].name, accountPlanId: accountPlan[4].id, items: [{ id: crypto.randomUUID(), description: 'Troca de Óleo CAT 320', value: 1500 }], totalValue: 1500, date: new Date().toLocaleDateString('en-CA'), docNumber: '998', paymentMethod: 'Dinheiro', paymentCondition: 'A Vista', status: 'Pago', bankAccountId: bankAccounts[0].id, paymentDate: new Date().toLocaleDateString('en-CA'), createdAt: Date.now() },
    { id: crypto.randomUUID(), vendorId: vendors[2].id, vendorName: vendors[2].name, accountPlanId: accountPlan[4].id, items: [{ id: crypto.randomUUID(), description: 'Filtros diversos', value: 850 }], totalValue: 850, date: new Date().toLocaleDateString('en-CA'), docNumber: '1234', paymentMethod: 'PIX', paymentCondition: 'A Vista', status: 'Pago', bankAccountId: bankAccounts[1].id, paymentDate: new Date().toLocaleDateString('en-CA'), createdAt: Date.now() },
    { id: crypto.randomUUID(), vendorId: vendors[3].id, vendorName: vendors[3].name, accountPlanId: accountPlan[3].id, items: [{ id: crypto.randomUUID(), description: 'Material de escritório', value: 200 }], totalValue: 200, date: new Date().toLocaleDateString('en-CA'), docNumber: '443', paymentMethod: 'Cartão Corporativo', paymentCondition: 'A Vista', status: 'Pago', paymentDate: new Date().toLocaleDateString('en-CA'), createdAt: Date.now() },
    { id: crypto.randomUUID(), vendorId: vendors[4].id, vendorName: vendors[4].name, accountPlanId: accountPlan[3].id, items: [{ id: crypto.randomUUID(), description: 'Segurança Mensal', value: 1200 }], totalValue: 1200, date: new Date().toLocaleDateString('en-CA'), docNumber: '887', paymentMethod: 'Boleto', paymentCondition: 'A Prazo', dueDate: new Date().toLocaleDateString('en-CA'), status: 'Pendente', createdAt: Date.now() }
  ];

  const maintenanceRecords: MaintenanceRecord[] = [
    { id: crypto.randomUUID(), equipmentId: fleet[0].id, date: new Date().toLocaleDateString('en-CA'), nfNumber: '998', performedItems: ['oilChange', 'oilFilter'], observations: 'Troca preventiva realizada na oficina do Giba', createdAt: Date.now() },
    { id: crypto.randomUUID(), equipmentId: fleet[1].id, date: new Date().toLocaleDateString('en-CA'), nfNumber: '101', performedItems: ['dieselFilter'], observations: 'Filtro saturado', createdAt: Date.now() },
    { id: crypto.randomUUID(), equipmentId: fleet[2].id, date: new Date().toLocaleDateString('en-CA'), nfNumber: '556', performedItems: ['others'], observations: 'Revisão de freios', createdAt: Date.now() },
    { id: crypto.randomUUID(), equipmentId: fleet[3].id, date: new Date().toLocaleDateString('en-CA'), nfNumber: '778', performedItems: ['externalAirFilter'], observations: 'Limpeza e troca', createdAt: Date.now() },
    { id: crypto.randomUUID(), equipmentId: fleet[4].id, date: new Date().toLocaleDateString('en-CA'), nfNumber: '223', performedItems: ['bleedDieselFilter'], observations: 'Drenagem de água', createdAt: Date.now() }
  ];
